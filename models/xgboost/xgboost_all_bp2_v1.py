...
# Peter R.
# XGBoost script
# All breaks, n_estimators (number of trees)=1000 and with optimal parameter from DRAC model_bp1 & early stopping
...
model_bp2.save_model("model_bp2_all_brks_v1.json")
# save in text format
